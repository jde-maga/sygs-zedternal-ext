class SygExt_Skill_Survivalist_ColdRiposte_Helper extends Info
	transient;
...
function Explosion()
{
	...
	if (bDeluxe)
		Player.Controller.Spawn(class'SygZedternalExtended.SygExt_Skill_Survivalist_ColdRiposte_ProjectileDeluxe', Player.Controller, , Loc, Rot, , True);
	else
		Player.Controller.Spawn(class'SygZedternalExtended.SygExt_Skill_Survivalist_ColdRiposte_Projectile', Player.Controller, , Loc, Rot, , True);
	PlayLocalEffects();
