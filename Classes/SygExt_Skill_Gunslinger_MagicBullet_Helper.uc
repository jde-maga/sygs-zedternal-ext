class SygExt_Skill_Gunslinger_MagicBullet_Helper extends Info
    transient;
...
function int UpdateAmmo(int AmmoIn, KFWeapon MyKFWeapon)
{
	...
	if (MyKFWeapon.MagazineCapacity[0] >= 1 && Ammo > 0 && MyKFWeapon.SpareAmmoCount[0] >= Ammo && (bDeluxe || AmmoCounter < MyKFWeapon.MagazineCapacity[0]))
	{
...
defaultproperties
{
    AmmoCounter=0
    bDeluxe=False
	Name="Default__SygExt_Skill_Gunslinger_MagicBullet_Helper"
}
