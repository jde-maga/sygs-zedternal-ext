class SygExt_WeapUpg_Illimitable extends WMUpgrade_Weapon
    abstract;
...
defaultproperties
{
    upgradeName="Illimitable"
    upgradeDescription(0)="Increase <font color=\"#ff3399\">all aspects</font> of this weapon by <font color=\"#66cc00\">%x%%</font>."
	WeaponBonus=(incValue=3,MaxValue=-1)
	Damage=0.030000
    Heal=0.030000
    KnockdownPower=0.030000
    MagSize=0.030000
    MeleeAttackSpeed=0.030000
    Penetration=0.030000
    RateOfFire=0.030000
    Recoil=0.030000
    ReloadRate=0.030000
    SpareAmmo=0.030000
    StumblePower=0.030000
    StunPower=0.030000
    Speed=0.030000
    Spread=0.030000
